...
OutputDir=J:\XDTC完成版170714\安装包
OutputBaseFilename=本济医信医疗设备数据转存软件
SetupIconFile=J:\XDTC完成版170714\安装包\image\logo.ico
Compression=lzma
SolidCompression=yes
WizardImageFile=J:\XDTC完成版170714\安装包\image\logo_Lift.bmp
WizardSmallImageFile=J:\XDTC完成版170714\安装包\image\logo_small.bmp
DisableDirPage=no
[Languages]
...
[Files]
Source: "J:\XDTC完成版170714\安装包\softword\MEDAS.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "J:\XDTC完成版170714\安装包\softword\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
